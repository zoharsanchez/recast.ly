...
window.exampleVideoData = [{
  ...
  id: {
    kind: 'youtube#video',
    videoId: '4ZAEBxGipoA' // props.video.id.videoId
  },
  snippet: { // props.video.snippet.title // description
    ...
    thumbnails: {
      default: {
        url: 'https://i.ytimg.com/vi/4ZAEBxGipoA/default.jpg', // props.video.snippet.thumbnails.default.url
        width: 120,
        height: 90
      },
      medium: {
